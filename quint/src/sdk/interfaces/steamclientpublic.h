...
//-----------------------------------------------------------------------------
inline bool BIsVRLaunchOptionType(const ELaunchOptionType  eType)
{
...
//-----------------------------------------------------------------------------
inline bool BIsOculusHMD(EVRHMDType eType)
{
...
//-----------------------------------------------------------------------------
inline bool BIsWindowsMRHeadset(EVRHMDType eType)
{
...
//-----------------------------------------------------------------------------
inline bool BIsViveHMD(EVRHMDType eType)
{
...
public:
	...
	//-----------------------------------------------------------------------------
	// Purpose: Converts the parts of a steam ID to a 64-bit representation.
	//			For multiseat accounts, all instances of that account will have the
	//			same account key, so they can be grouped together by the static
	//			account key.
	// Output : 64-bit account key
	//-----------------------------------------------------------------------------
	uint64 GetStaticAccountKey() const
	{
		// note we do NOT include the account instance (which is a dynamic property) in the account key
	...
	const char* Render(uint64 ulSteamID);	// method to render a uint64 representation of a steam ID to a string
...
public:
	...
	const char* Render(uint64 ulGameID);		// method to render a uint64 representation of a Game ID to a string
